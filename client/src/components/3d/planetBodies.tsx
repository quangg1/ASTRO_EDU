...
export function PlanetLabel({
  ...
  const df = compact ? 5.5 : 20
  return (
    <Html distanceFactor={df} position={[radius * 1.55, radius * 0.14, 0]}>
      <div
        className={
          compact
            ? 'select-none whitespace-nowrap rounded-md px-1.5 py-0.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-white'
        ...
        style={{
          ...
          WebkitTextStroke: compact ? '0.35px rgba(0,0,0,0.5)' : '0.8px rgba(0,0,0,0.45)',
          background: compact ? 'rgba(0,0,0,0.45)' : 'rgba(0,0,0,0.12)',
        }}
