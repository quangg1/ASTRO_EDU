...
type Props = {
  ...
  className?: string
  variant?: 'default' | 'prominent' | 'rail'
}
      ...
      {chips.map((c) => (
        <button
          ...
          className={clsx(
            ...
            rail &&
              'max-w-[min(220px,72vw)] shrink-0 truncate border-ds-border bg-white/5 px-3 py-1.5 text-gray-300 hover:border-cyan-400/30 hover:text-ds-text',
            prominent &&
