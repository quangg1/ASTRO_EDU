...
import { DEPTH_META, getLessonNeighbors, getLessonById } from '@/features/learning-path/data/learningPathCurriculum'
import {
...
import { LessonRecallQuizOverlay } from '@/features/learning-path/ui/LessonRecallQuizOverlay'
import { LessonNextStepPanel } from '@/features/learning-path/ui/LessonNextStepPanel'
...
import { CommunityAskButton, LessonRelatedQuestions } from '@/features/community/public'
import { SaveLessonButton } from '@/features/saved/public'
import { placeholderBody } from './lessonHtml'

export type LearningLessonViewProps = {
  ...
  return (
    ...
    <div className="relative z-10 w-full overflow-x-hidden text-ds-text">
      ...
      >
        ...
        {(done || mastered) && !(recallGateActive && !mastered) ? (
          <LessonNextStepPanel lessonId={lesson.id} lessonTitle={lesson.titleVi || lesson.title} />
        ) : null}
