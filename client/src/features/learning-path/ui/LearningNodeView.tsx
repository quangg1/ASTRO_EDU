...
import type { LearningModule, LearningNode } from '@/features/learning-path/data/learningPathCurriculum'
import { getLearningPathNeighbors } from '@/features/learning-path/data/learningPathCurriculum'
import NodeDepthPanel from '@/features/learning-path/ui/NodeDepthPanel'
