...
import { getNasaCatalogItemById, NASA_SHOWCASE_ITEMS } from '@/features/content3d/showcase/lib/showcaseEntities'
...
import { syncShowcaseOrbitEntityFromJpl } from '../../api/showcaseOrbitsApi'
...
export function StudioShowcaseEntitiesPage() {
...
export function StudioShowcaseEntitiesPageWithSuspense() {
  return (
    <Suspense
      fallback={
