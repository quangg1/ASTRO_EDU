...
// Previously lived under `features/content3d/narrative/` — moved here because
// the entire narrative wrapper was an unused abstraction layer on top of the
// (single) Earth History dataset. See ARCHITECTURE_AUDIT Drift 3.6.E.
